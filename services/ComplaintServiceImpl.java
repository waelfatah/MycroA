...
public class ComplaintServiceImpl implements IComplaintService{
	...
	@Override
	public Complaint addComplaint(Complaint c,int idClient) {
		Client client=clientRepository.findById(idClient).get();
		if (c.getType()==Type.RECLAMATION){
			mailClient.prepareAndSend(client.getMailClient(), client.getfNameClient(), client.getlNameClient(), c.getDescription());			
		}
